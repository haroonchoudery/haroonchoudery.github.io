...
$(document).ready(function() {
 ...
 $('.loading').fadeIn('slow').html('<p class="text-success">Form submitted Successfully.</p>').delay(3000).fadeOut('slow');
     else
     $('.loading').fadeIn('slow').html('<p class="text-danger">Oops. Something went wrong</p>').delay(3000).fadeOut('slow');
